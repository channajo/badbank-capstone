        ...
        show ? (
          user.email ? (
            <>
              ...
              <br />
              <br />
              <button type="submit" disabled={value ? false : true} className="btn btn-light" class="btn btn-secondary btn-lg" onClick={handleWithdraw}>
                Withdraw
              </button>
              <br />
            </>
          ...
          <>
            <h5>Success!</h5>
            <br />
            <button type="submit" className="btn btn-light" class="btn btn-secondary btn-lg" onClick={clearForm}>
